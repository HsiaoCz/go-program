...
![image-20220914213039773](C:\Users\xiaochengzhou\AppData\Roaming\Typora\typora-user-images\image-20220914213039773.png)
...
func main(){
	//连接MySQL数据库
	db,err:=gorm.Open("mysql","root:admin123@(192.168.1.3:3306)/db1?charset=utf8mb4&parseTime=True&loc=Local")
    if err != nil {
		panic(err)
	}
	defer db.Close()
...
![image-20220914223130359](C:\Users\xiaochengzhou\AppData\Roaming\Typora\typora-user-images\image-20220914223130359.png)
